...
import { notifClosed } from '../../actions';
...
class NotificationPanel extends Component {
    ...
    componentDidMount() {
        this.timer = setTimeout( () => { this.props.notifClosed()}, 8000);
      }
    ...
    render() {
        const {isEditModeActive, isNotificationOpened} = this.props;

        if(!isEditModeActive && isNotificationOpened) {
            return (
                <div className="notification-panel d-flex">
                    <div className="notification-panel-icon " >
                        <svg className="d-block" width="29" height="38" viewBox="0 0 29 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="notification-panel-body align-middle" >
                        <h2 className="notification-panel-body-title" >Don’t forget to publish weekly notes about manager’s work!</h2>
                        Notification will be closed after 8 seconds
                    </div>
                    <div className="notification-panel-close ml-auto" >
                        <svg onClick={ this.props.notifClosed} className="d-block" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const mapStateToProps = ({ isEditModeActive, isNotificationOpened}) => {
    return { isEditModeActive, isNotificationOpened};
}
